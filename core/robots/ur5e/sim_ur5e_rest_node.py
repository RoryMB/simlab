...
from sim_ur5e_interface import SimUR5e
...
class SimUR5eNode(URNode):
    ...
    def gripper_pick(
        ...
        try:
            coord_type = CoordinateType.JOINT_ANGLES if joint_angle_locations else CoordinateType.CARTESIAN
            ...
            if self.ur5e_interface.move_to_location(source_coords, coord_type):
                success = self.ur5e_interface.close_gripper()

...
def main():
    ...
    try:
        ...
        print("     * UR5e node: ./run_node_ur5e.sh (http://127.0.0.1:8018/)")
        print("     * PF400 node: ./run_node_pf400.sh (http://127.0.0.1:8020/)")
        print("     * OT2 node: ./run_node_ot2.sh (http://127.0.0.1:8019/)")
